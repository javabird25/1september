"""
Django settings for september1 project.
...
MIDDLEWARE = [
    ...
    'app.middleware.work_in_progress',
]

ROOT_URLCONF = 'september1.urls'
...
WSGI_APPLICATION = 'september1.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'webpack-out'),
]
...
WEBPACK_LOADER = {
    'DEFAULT': {
        'CACHE': not DEBUG,
        'BUNDLE_DIR_NAME': '',
        'STATS_FILE': os.path.join(BASE_DIR, 'webpack-out/webpack-stats.json'),
        'POLL_INTERVAL': 0.1,
        'TIMEOUT': None,
