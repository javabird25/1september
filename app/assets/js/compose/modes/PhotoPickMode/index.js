        ...
        <Mode className="photo-pick">
            <div className="message">
                <div className="instruction">
                    <p>
                        Поздравляем, ты справился с заданием! Ты очень умный ребёнок!
                        А теперь нам не терпится узнать, кем бы ты хотел стать в будущем.
                        Выбери интересующее тебя направление и сделай классное фото на память.
                    </p>
                    <p>
                        Нажми на кнопку «Выбери файл» и загрузи фотографию.
                        После этого кликни на кнопку «Продолжить».
                    </p>
                </div>
